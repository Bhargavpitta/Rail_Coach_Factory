        ...
        <div className="surplus-card-body">
          ...
          <div className="surplus-note-box">
            <p className="surplus-note">
              <strong>NOTE:</strong> RCF shall make arrangements to issue
              material to all zonal Railways / Pus on all working days of the
              week subject to availability of staff.
            </p>
          </div>

          <p className="surplus-desc">
            Following items are surplus at RCF. Railways may review these
            lists and send their requirements, if any.
          </p>

          <div className="surplus-contact">
            <p>
              For any inquiry please contact <strong>CMM, RCF Kapurthala</strong>{" "}
              at the following Telephone Nos.
            </p>
          ...
          <div className="items-spared-section">
            <h3 className="items-spared-title">
              ITEMS TO BE SPARED FOR RAILWAYS
            </h3>
